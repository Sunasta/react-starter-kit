          ...
          <CardContent>
            <Form {...form}>
              <form className='flex flex-col gap-2 mb-2' onSubmit={form.handleSubmit(onSubmit)}>
                ...
                />
                <Button className='mt-2' type="submit"><FormattedMessage id='pages.login' /></Button>
              </form>
            </Form>
          </CardContent>
          <CardFooter className='justify-center'>
            <Link to="/register" className='text-primary'><FormattedMessage id='pages.login.not_registered' /></Link>
          </CardFooter>
        </Card>
      </div>
    </>
